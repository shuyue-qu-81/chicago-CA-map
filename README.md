...
## Description
The interactive map shows the spatial distribution and area size of the 77 CAs in Chicago. Hover the mouse to display the CA name and area (km²). The interactive function is implemented based on the OpenStreetMap base map. A small overview map is displayed in the bottom-right corner to provide geographic context of Chicago within a broader spatial scale.
